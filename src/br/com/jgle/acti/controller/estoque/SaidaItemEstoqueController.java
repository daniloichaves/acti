...
@Scope("page")
@Controller
public class SaidaItemEstoqueController extends AbstractController<EstoqueItem> {
	...
	public SaidaItemEstoqueController() {
		super(new EstoqueItem());
	}

	@SuppressWarnings({ "rawtypes", "unchecked" })
	public SaidaItemEstoqueController(AbstractController parent) {
