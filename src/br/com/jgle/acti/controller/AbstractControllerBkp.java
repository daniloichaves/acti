...
public class AbstractControllerBkp<T extends AbstractEntity> extends GenericForwardComposer {
	...
	public Collection<T> getReminders() {
		...
		list = genericService.procurarTodos(entityClass);
		return list;
	}
	...
	public void makeSearch() {
		list = genericService.procurarSimples(selected, entitySearch.getValue());
		_search = true;
		refreshModel();
